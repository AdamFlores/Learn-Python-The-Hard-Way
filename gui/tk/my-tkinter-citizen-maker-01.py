...
Senator
Judge
Factory Union Leader
Factory Boss
Factory Owner
Skilled Factory Worker
Unskilled Factory Worker
Farm Worker Union Leader
Farm Boss
Farm Owner
Skilled Farm Worker
Unskilled Farm Worker
Master Farm Worker
Master Factory Worker
Principal 
Dean Teacher
Professor
Power Owner
Power Union Boss
Skilled Power Worker
Unskilled Power Worked 
Master Power Worker
Store Owner
Store Union Boss
Store Boss
...
Doctoral Student
"""
fout = open("citizen_data.txt", "w")
fout.write(str1)
fout.close()
 
# read the data file into a list
fin = open("citizen_data.txt", "r")
...
root = tk.Tk()
root.title("Citizen Occupation List")
# create the listbox (note that size is in characters)
listbox1 = tk.Listbox(root, width=50, height=25)
