...
class GrossiniLayer2(Layer):
    def __init__( self ):
        ...
        self.add( g1 )
        self.add( g2 )
class IntroLayer1(Layer):
    def __init__(self):
        super(IntroLayer1, self).__init__()
        #define label here
        #add label here
class MapLayer1(Layer):
    def __init__(self):
        super(MapLayer1, self).__init__()
        #define label here
        #add label here
class BuildingLayer1(Layer):
    def __init__(self):
        super(BuildingLayer1).__init__()
        #define label here
        #add label here
class CitizenLayer1(Layer):
    def __init__(self):
        super(CitizenLayer1).__init__()
         #define label here
        #add label here
class OfficeLayer1(Layer):
    def __init__(self):
        super(OfficeLayer1).__init__()
         #define label here
        #add label here
class OfficeUILayer1(Layer):
    def __init__(self):
        super(OfficeLayer1).__init__()
         #define label here
        #add label here
